...
public class ECSServiceContextModule extends ComputeServiceAdapterContextModule<Instance, InstanceType, org.jclouds.aliyun.ecs.domain.Image, Region> {

   @Override
   protected void configure() {
      super.configure();

      bind(new TypeLiteral<ComputeServiceAdapter<Instance, InstanceType, org.jclouds.aliyun.ecs.domain.Image, Region>>() {
      ...
      bind(new TypeLiteral<Function<org.jclouds.aliyun.ecs.domain.Image, org.jclouds.compute.domain.Image>>() {
      ...
      install(new LocationsFromComputeServiceAdapterModule<Instance, InstanceType, org.jclouds.aliyun.ecs.domain.Image, Region>() {
      });
   ...
   static class InstanceInStatusPredicate implements Predicate<String> {
      ...
      public boolean apply(String id) {
         ...
         InstanceStatus instanceStatus = Iterables
                 .tryFind(api.instanceApi().getStatus(regionId), new InstanceStatusPredicate(instanceId)).orNull();
