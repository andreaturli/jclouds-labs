...
public class CreateInstanceOptions extends BaseHttpRequestOptions {
   ...
   /**
    * Configures the internet charge type of the instances to be returned.
    */
   ...
   /**
    * Configures the internet max bandwidth out of the instances to be returned.
    */
   ...
   /**
    * Configures the instance charge type of the instances to be returned.
    */
