...
public interface InstanceApi {
   ...
   InstanceRequest create(@QueryParam("RegionId") String regionId, @QueryParam("ImageId") String imageId,
                          @QueryParam("SecurityGroupId") String securityGroupId, @QueryParam("HostName") String hostname,
   ...
   void delete(@QueryParam("InstanceId") String instanceId);

   @Named("instance:powerOff")
   @POST
   @Produces(MediaType.APPLICATION_JSON)
   @QueryParams(keys = "Action", values = "StopInstance")
   void powerOff(@QueryParam("InstanceId") String instanceId);

   @Named("instance:powerOn")
   @POST
   @Produces(MediaType.APPLICATION_JSON)
   @QueryParams(keys = "Action", values = "StartInstance")
   void powerOn(@QueryParam("InstanceId") String instanceId);

   @Named("instance:reboot")
   @POST
   @Produces(MediaType.APPLICATION_JSON)
   @QueryParams(keys = "Action", values = "RebootInstance")
   void reboot(@QueryParam("InstanceId") String instanceId);
