 ...
 */
public class KeyVaultFilter implements OAuthFilter {
   ...
   @Inject
   KeyVaultFilter(AuthorizeToken loader, @Named(PROPERTY_SESSION_INTERVAL) long tokenDuration,
   ...
   public HttpRequest filter(HttpRequest request) throws HttpException {
      ...
      ClientSecret client = ClientSecret.create(
              ...
              resource == null ? "" : "https://vault.azure.net", //resource,
      ...
      return request.toBuilder().replaceHeader("Authorization", authorization).build();
   }
}
